...
export const CHECKS = [
  ...
  },
  {
    ...
    blindSpot:
      ...
      + 'порушення в кожну з 288 позицій цього файлу не загубилася в жодній із 153 '
      + 'позицій живого коду (виміряно). Прогноз «досяжно вже наступною задачею» '
      + 'замінено на цей вимір',
  },
  {
    id: 'no-secrets',
    tier: 'fast',
    ...
    // називала ще lock-файли й дві копії вендорених скілів; їх виміряли (0 знахідок
    // на 12 629 рядків), виключення скасували — і цей рядок скоротили разом із ними,
    // щоб проза не пережила код, який вона описує.
    blindSpot:
