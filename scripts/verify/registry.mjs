...
export const CHECKS = [
  ...
  },
  {
    ...
    blindSpot:
      ...
      + 'усередині. Задача 6 кладе в периметр `checks/no-secrets.mjs` — найщільнішу '
      + 'тут концентрацію регекс-літералів, — тобто робить регекс-гілку класу '
      + 'досяжною вже наступною задачею',
  },
  {
    id: 'no-secrets',
    tier: 'fast',
    ...
    blindSpot:
      ...
      + 'секрет, вписаний у будь-який із них, невидимий. Обидва пропуски — бінарний '
      + 'і поіменний — порахано й надруковано в підсумку кожного прогону, і зеленого теж',
  },
  {
    id: 'build',
    tier: 'full',
