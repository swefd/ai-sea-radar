...
export const CHECKS = [
  ...
  },
  {
    ...
    proves:
      ...
      + '`reference`, у жодній із семи впізнаваних форм — ні в рантаймі, ні на рівні '
      + 'типів, ні в багаторядковій формі, ні коли між ключовим словом і `from` стоїть '
      + 'коментар із крапкою з комою',
