...
export const CHECKS = [
  ...
  },
  {
    ...
    blindSpot:
      ...
      + 'секрет, вписаний у будь-який із них, невидимий. Усі три пропуски — бінарний, '
      + 'поіменний і плейсхолдерний — порахано й надруковано в підсумку кожного '
      + 'прогону, і зеленого теж',
  },
  {
    id: 'build',
    tier: 'full',
