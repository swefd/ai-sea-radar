...
Перші два числа цього абзацу стереже тест, названий вище. Два останні — **ні, і не можуть**: вони з документації Claude Code, а не з файлу цього репозиторію, тож у разі її зміни ця фраза застаріє мовчки. Звіряйте їх із документацією, а не з цим рядком.
