...
розділ 2 того файлу. Тут його навмисно немає: це довідка на кілька десятків кілобайт,
яку відкривають свідомо, а не настанова, потрібна щоходу. Там-таки лежить решта
матеріалу для запису checkpoint і повний перелік названих меж шару.
